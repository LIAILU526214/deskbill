...
/**
 * 添加分类的对话框 子类是AddSortController
 */
@SuppressWarnings({"unchecked","rawtypes"})
public abstract class AbstractOperationSortDialog extends JDialog {
	private static final long serialVersionUID = 5386714014167732322L;

	protected JComboBox parentBox = new JComboBox(new DefaultComboBoxModel(new String[] { "支出","收入" }));// 父分类
