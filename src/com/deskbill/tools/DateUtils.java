...
public class DateUtils {
	 ...
	 * @param dateSrc 日期字符串
	 * @param pattern 日期格式
	 * @return 返回java.util.Date 日期
	 * @throws ParseException
	 */
	public static java.util.Date formatStringDate(String dateSrc,String pattern) throws ParseException {
		SimpleDateFormat dateFormat = new SimpleDateFormat(pattern);
		return dateFormat.parse(dateSrc);
	}
}
